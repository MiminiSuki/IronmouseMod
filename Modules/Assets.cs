...
namespace IronmouseMod.Modules
{
    ...
    {
        //getting stuff for pewpew
        //didnt know how to get this cus I was looking at the decomp game code and void fiends stuff weren't static so couldn't pull from it
        ...
        internal static AssetBundle LoadAssetBundle(string bundleName)
        {
            ...
            try
            {
                assetBundle = AssetBundle.LoadFromFile(Path.Combine(Path.GetDirectoryName(IronmousePlugin.instance.Info.Location), "AssetBundles", bundleName));
            }
